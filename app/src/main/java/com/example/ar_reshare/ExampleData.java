...
public class ExampleData {
    ...
    private ExampleData() {
        ...
        user0.setBio("Tag me on Linkedin!");
        users.add(user0);
        ...
        user1.setBio("Free coffee connoisseur");
        ...
        user2.setBio("Nobel Peace Prize for Software Engineering");
        users.add(user2);
        ...
        user3.setBio("Paw Patrol GO GO GO");
        users.add(user3);
        ...
        user4.setBio("Distinguished software engineer from Bristol");
        users.add(user4);
        ...
        user5.setBio("Established TikTok influencer");
