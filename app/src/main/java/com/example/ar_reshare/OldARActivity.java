...
public class OldARActivity extends AppCompatActivity implements SampleRender.Renderer {
    ...
    private void checkIfARAvailable() {
        ...
        if (!availability.isSupported()) {
            Intent intent = new Intent(OldARActivity.this, FallbackActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_old_aractivity);
